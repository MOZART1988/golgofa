...
( function() {
	...
	CKEDITOR.dialog.add( 'aboutTemplates', function( editor ) {
		...
		// Load skin at first.
		var plugin = CKEDITOR.plugins.get( 'aboutTemplates' );
		...
		var templateListLabelId = 'cke_tpl_list_label_' + CKEDITOR.tools.getNextNumber(),
			lang = editor.lang.aboutTemplates,
			config = editor.config;
		return {
			title: editor.lang.aboutTemplates.title,
